<?php if (display_admin_part() == false) : ?>
    ...
    <aside class="app-sidebar sidebar-scroll">
        <div class="main-sidebar-header">
            <a class="desktop-logo logo-light" href="<?php echo esc_url(admin_url('admin.php?page=shelf_planner')); ?>"><img src="<?php echo esc_url(plugin_dir_url(__FILE__)); ?>assets/img/brand/logo.png?1" class="main-logo" style="width: 199px; height: 28px;" alt="logo"></a>
        </div>
