...
/***/ "./packages/navigation/build-module/filters.js":
/*!*****************************************************!*\
  !*** ./packages/navigation/build-module/filters.js ***!
  \*****************************************************/
/*! exports provided: flattenFilters, getActiveFiltersFromQuery, getDefaultOptionValue, getQueryFromActiveFilters, getUrlKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "flattenFilters", function() { return flattenFilters; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getActiveFiltersFromQuery", function() { return getActiveFiltersFromQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaultOptionValue", function() { return getDefaultOptionValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getQueryFromActiveFilters", function() { return getQueryFromActiveFilters; });
...
function flattenFilters(filters) {
  ...
  filters.forEach(function (f) {
    if (!f.subFilters) {
      ...
      allFilters.push(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["omit"])(f, 'subFilters'));
      var subFilters = flattenFilters(f.subFilters);
      allFilters.push.apply(allFilters, Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(subFilters));
    }
  });
  return allFilters;
}
...
function getActiveFiltersFromQuery(query, config) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["compact"])(Object.keys(config).map(function (configKey) {
    var filter = config[configKey];

    if (filter.rules) {
      var match = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["find"])(filter.rules, function (rule) {
...
function getDefaultOptionValue(config, options) {
  ...
  if (config.input.defaultOption) {
    var option = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["find"])(options, {
      value: defaultOption
    });
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(options, [0, 'value']);
}
/**
...
function getQueryFromActiveFilters(activeFilters, query, config) {
  ...
  return _objectSpread({}, previousData, {}, nextData);
}
/**
...
/***/ "./packages/navigation/build-module/history.js":
/*!*****************************************************!*\
  !*** ./packages/navigation/build-module/history.js ***!
  \*****************************************************/
/*! exports provided: getHistory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  if (!_history) {
    ...
    _history = {
      ...
      get location() {
        ...
        var query = Object(qs__WEBPACK_IMPORTED_MODULE_2__["parse"])(location.search.substring(1));
...
/***/ "./packages/navigation/build-module/index.js":
/*!***************************************************!*\
  !*** ./packages/navigation/build-module/index.js ***!
  \***************************************************/
/*! exports provided: getHistory, flattenFilters, getActiveFiltersFromQuery, getDefaultOptionValue, getQueryFromActiveFilters, getUrlKey, getAdminLink, getPath, getPersistedQuery, getIdsFromQuery, getSearchWords, getNewPath, getQuery, onQueryChange, updateQueryString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPersistedQuery", function() { return getPersistedQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getIdsFromQuery", function() { return getIdsFromQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSearchWords", function() { return getSearchWords; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNewPath", function() { return getNewPath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getQuery", function() { return getQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onQueryChange", function() { return onQueryChange; });
...
/* harmony import */ var _history__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./history */ "./packages/navigation/build-module/history.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getHistory", function() { return _history__WEBPACK_IMPORTED_MODULE_5__["getHistory"]; });

/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filters */ "./packages/navigation/build-module/filters.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "flattenFilters", function() { return _filters__WEBPACK_IMPORTED_MODULE_6__["flattenFilters"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getActiveFiltersFromQuery", function() { return _filters__WEBPACK_IMPORTED_MODULE_6__["getActiveFiltersFromQuery"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getDefaultOptionValue", function() { return _filters__WEBPACK_IMPORTED_MODULE_6__["getDefaultOptionValue"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getQueryFromActiveFilters", function() { return _filters__WEBPACK_IMPORTED_MODULE_6__["getQueryFromActiveFilters"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getUrlKey", function() { return _filters__WEBPACK_IMPORTED_MODULE_6__["getUrlKey"]; });

/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index */ "./packages/navigation/build-module/index.js");
...
var getAdminLink = function getAdminLink(path) {
...
var getPath = function getPath() {
  return Object(_history__WEBPACK_IMPORTED_MODULE_5__["getHistory"])().location.pathname;
};
/**
 * Gets query parameters that should persist between screens or updates
 * to reports, such as filtering.
 *
 * @param {Object} query QuerySP containing the parameters.
 * @return {Object} Object containing the persisted queries.
 */

var getPersistedQuery = function getPersistedQuery() {
  var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _index__WEBPACK_IMPORTED_MODULE_7__["getQuery"]();
  return Object(lodash__WEBPACK_IMPORTED_MODULE_4__["pick"])(query, ['period', 'compare', 'before', 'after', 'interval', 'type']);
};
/**
...
function getIdsFromQuery() {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_4__["uniq"])(queryString.split(',').map(function (id) {
 ...
 *
 * @param {Object} query QuerySP object.
...
function getSearchWords() {
  ...
  if (Object(_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__["default"])(query) !== 'object') {
...
function getNewPath(query) {
  ...
  var args = _objectSpread({
    page: 'shelf_planner_retail_insights'
  }, currentQuery, {}, query);
  ...
  return Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_2__["addQueryArgs"])('admin.php', args);
}
/**
...
function getQuery() {
  var search = Object(_history__WEBPACK_IMPORTED_MODULE_5__["getHistory"])().location.search;

  if (search.length) {
    return Object(qs__WEBPACK_IMPORTED_MODULE_3__["parse"])(search.substring(1)) || {};
  }
  ...
  switch (param) {
    ...
    case 'compare':
      return function (key, queryParam, ids) {
        ...
        return updateQueryString((_updateQueryString = {}, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_updateQueryString, queryParam, "compare-".concat(key)), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_updateQueryString, key, ids), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_updateQueryString, "search", undefined), _updateQueryString), path, query);
      };

    default:
      return function (value) {
        return updateQueryString(Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, param, value), path, query);
      };
  }
}
/**
...
function updateQueryString(query) {
  ...
  Object(_history__WEBPACK_IMPORTED_MODULE_5__["getHistory"])().push(newPath);
}
