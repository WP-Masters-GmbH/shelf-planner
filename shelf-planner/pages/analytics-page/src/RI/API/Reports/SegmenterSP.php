...
class SegmenterSP
{
    ...
    /**
     * QuerySP arguments supplied by the user for data store.
     *
     * @var array
     */
     ...
     * Constructor.
     *
     * @param array $query_args     QuerySP arguments supplied by the user for data store.
    ...
    protected function merge_segment_intervals_results($segment_dimension, $result1, $result2)
    {
        ...
        foreach ($result1 as $segment_data) {
            ...
            unset($segment_data['time_interval'] , $segment_data['datetime_anchor'] , $segment_data[$segment_dimension]);
    ...
    protected function reformat_intervals_segments($segments_db_result, $segment_dimension)
    {
        ...
        foreach ($segments_db_result as $segment_data) {
            ...
            unset($segment_data['time_interval'] , $segment_data['datetime_anchor']);
