 ...
 *         );
 * $report = new \QuickAssortmentsSP\COG\RISP\API\Reports\Products\Stats\QuerySP( $args );
...
use QuickAssortmentsSP\COG\RI\API\Reports\QuerySP as ReportsQuery;

/**
 * API\Reports\Products\Stats\QuerySP.
 */
class QuerySP extends ReportsQuery
{
    /**
