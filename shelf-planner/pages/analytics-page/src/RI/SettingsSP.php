 ...
 * @since    2.0.0
 */
final class SettingsSP extends AbstractSettingsSP
{
    /**
    ...
    {
        $this->id              = 'qa_cog_ri_settings_sp';
        $this->label           = __('Retail Insights Settings SP', 'qa-cost-of-goods-margins');
        ...
        switch ($section) {
            case $this->id:
                $settings = apply_filters('qa_cog_ri_' . $section . '_body', [
                    [
                        'title' => __('Retail Insights SettingsSPSP', 'qa-cost-of-goods-margins'),
                        'type'  => 'title',
                        'id'    => $this->id . '_retail_insights_settings_section',
                    ],
                    [
                        'title'    => __('Exclude OrderSP Statuses', 'qa-cost-of-goods-margins'),
    ...
    {
        $sections[$this->id] = __('Retail Insights SettingsSPSP', 'qa-cost-of-goods-margins');
