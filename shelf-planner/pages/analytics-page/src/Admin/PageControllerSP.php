...
final class PageControllerSP
{
    ...
    public static function include_scripts_styles() {
	    ...
	    if(isset($_GET['page']) && in_array($_GET['page'], $remove_pages)) {
		    ...
		    wp_enqueue_script( 'sp-tips', MAIN_SP_URL . 'assets/protip/protip.min.js', array( 'jquery' ), time(), false );
		    ...
		    wp_enqueue_style( 'sp-tips', MAIN_SP_URL . 'assets/protip/protip.min.css' );
	    }
    }
     ...
     *   @type string|array title        PageSP title. Used in menus and breadcrumbs.
    ...
    /**
     * Get breadcrumbs for QuickAssortments Admin PageSP navigation.
     *
     ...
     *
     *   @type string      id           Id to reference the page.
     *   @type string      title        PageSP title. Used in menus and breadcrumbs.
     *   @type string|null parent       Parent ID. Null for new top level page.
