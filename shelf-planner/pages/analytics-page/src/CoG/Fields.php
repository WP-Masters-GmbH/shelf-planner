...
final class Fields
{
     ...
     * @since 1.0.0
     */
    private $prefix = QA_COG_PREFIX; // TODO: Use the constant QA_COG_PREFIX directly instead of prefix
    ...
    public function __construct()
    {
        ...
        $this->bi       = 'background-image: url("' . QA_COG_BASE_URL . 'assets/img/icon-sq-bg.png")';
    ...
    public function add_cost_field_to_product_data_tab()
    {
        ...
        $fields['margin_excl_tax'] = [
            ...
            'name'              => '',
            'class'             => 'qa-input-field',
            'value'             => ($m = Helpers\Formulae::margin($cp, $price_excl_tax)) ? $m . '%' : '-',
            'data_type'         => 'price',
            'placeholder'       => '0',
    ...
    public function add_cost_field_to_variation_data_tab($loop, $variation_data, $variation)
    {
        ...
        $cp = Helpers\Methods::get_cost($variation);
    ...
    public function add_generic_cost_field_to_variable_product()
    {
        ...
        woocommerce_wp_text_input(
            [
                ...
                'value'       => Helpers\Methods::get_cost($product->get_id()),
