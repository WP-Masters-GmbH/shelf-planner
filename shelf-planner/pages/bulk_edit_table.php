    ...
    <table class="widefat fixed" cellspacing="0">
        ...
        while($products->have_posts()) : $products->the_post();
            ...
            <tr class="bulk-product-item" data-product-id="<?php echo esc_html($product_id); ?>">
                ...
                <th class="column-cost num" scope="col" style="<?php if(!in_array('sp_activate_replenishment', $columns)) {echo esc_attr('display: none;');}?>"><input type="number" class="sp_activate_replenishment smaller-input" value="<?php echo esc_html($item_data->sp_activate_replenishment); ?>"></th>
                ...
                <th class="column-cost num" scope="col" style="<?php if(!in_array('sp_on_hold', $columns)) {echo esc_attr('display: none;');}?>"><select class="sp_on_hold smaller-input" value="<?php echo esc_html($item_data->sp_on_hold); ?>"><option value="Yes">Yes</option><option value="No">No</option></select></th>
