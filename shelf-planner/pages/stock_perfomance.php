            ...
            <?php include __DIR__ . '/../' . "page_header.php"; ?>
                ...
                <div class="container">
                    ...
                    <div class="d-flex nav-link-line" style="margin-top: 40px;">
                          ...
                          <a class="nav-link-page <?php echo esc_attr(sanitize_text_field($_GET['page']) == 'shelf_planner_stock_detail' ? 'not-active' : ''); ?>" href="<?php echo esc_url(admin_url('admin.php?page=shelf_planner_stock_detail')); ?>"><span  class="side-menu__label"> <?php echo esc_html(__('Stock Detail', QA_MAIN_DOMAIN)); ?></span></a>
                        </div>
              ...
              <div style="margin-top: 60px;" class="d-flex justify-content-between">
                ...
                <table class="leaderboards-tab" style="margin-left: 120px;">
                  <tr>
                    <td class="leadeboards-tab-title">
              ...
              <button type="button" class="new-des-btn" style="width: 138px; margin-top: 20px; margin-left: 15px; font-size: 11px;">
                Go To Stock Detail
              </button>
            </div>
        </div>
