...
<div style="width: 51%; text-align: left; position: relative; display: inline-block"
    ...
    <p><?php echo ( __( 'You will also find tips and tricks on our user guides on <a href="https://merchants.shelfplanner.com" target="_blank">merchants.shelfplanner.com</a>', QA_MAIN_DOMAIN ) ); ?></p>
    ...
    <p><?php echo ( __( 'By installing this plugin, you agree to Shelf Planner’s', QA_MAIN_DOMAIN ) ); ?> <a href="https://shelfplanner.com/terms-conditions/" target="_blank"><?php echo esc_html( __( 'Terms & Conditions', QA_MAIN_DOMAIN ) ) ?></a></p>
